...
[isInModel,geneID] = ismember(geneList,regexprep(model.genes,'_deleted',''));
[~,geneInd] = ismember(regexprep(model.genes,'_deleted',''),geneList);
...
if (all(isInModel))
  ...
  deletedGenes = find( geneInd ) ;
  geneInd =  find( geneInd ) ;
