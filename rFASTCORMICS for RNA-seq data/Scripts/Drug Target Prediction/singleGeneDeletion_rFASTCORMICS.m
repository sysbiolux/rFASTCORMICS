function [grRatio, grRateKO, grRateWT, hasEffect, delRxns, fluxSolution, geneList] = singleGeneDeletion(model, method, geneList, verbFlag, uniqueGene)
% script adapted from the COBRA toolbox to correctly match genes and output the genelist
