function [model, A_final] = fastcormics_RNAseq_cobra(model, data, rownames, dico, biomass_rxn, already_mapped_tag, consensus_proportion, epsilon, optional_settings)
...
if ~isempty(function_keep)
    ...
    A      = fastcore_cobra_non_pen(model, B, epsilon, 0, C);
