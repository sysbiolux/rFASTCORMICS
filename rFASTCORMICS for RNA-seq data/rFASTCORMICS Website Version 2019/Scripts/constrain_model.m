function [model] = constrain_model(model, medium_mets, not_medium_constrained)
...
[exRxns, Ex_orgaInd] = findEX_Rxns(model, 'biomass_reaction');
...
if ~isempty(not_medium_constrained)|~isempty(not_constrained);
