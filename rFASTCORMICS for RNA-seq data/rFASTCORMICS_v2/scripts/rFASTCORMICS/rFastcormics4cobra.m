function [contextSpecificModel, retainedRxns, indicesCompletedCoreOrig] = rFastcormics4cobra(model, discretized, rownames, dico, biomassReactionName, consensusProportion, epsilon, optionalSettings, fillingMediumFlag, adaptiveScalingFlag)
...
% USAGE:
%
%   [contextSpecificModel, retainedRxns, indicesCompletedCoreOrig] = rFastcormics4cobra(model, discretized, rownames, dico, biomassReactionName, consensusProportion, epsilon, optionalSettings, fillingMediumFlag, adaptiveScalingFlag)
%
% REQUIREMENTS:
