...
if figflag;figure; hold on
    ...
    if strcmp(pathFigures,'')
        ...
        saveas(gcf,[pathFigures,'Figures\Discretization\density_all.png']); close all
...
if figflag;figure; hold on
    ...
    if strcmp(pathFigures,'')
        saveas(gcf,['Figures\Discretization\density_plots.png']); close all
    else
        
        saveas(gcf,[pathFigures,'Figures\Discretization\density_plots.png']); close all
