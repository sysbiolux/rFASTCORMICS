...
%                        contain multiple columns, with different
%                        identifiers.
...
mappedToGenes = zeros(numel(model.genes), size(mapped,2)); %initialise the variable that will contain discretized expression data for 
% genes of the model that have a discretized value
